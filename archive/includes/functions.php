...
/********************************/
	...
	function checkurlprepend($urlwebsiteinput) {
			$httpprefix = preg_match("/^http/", $urlwebsiteinput);
			$httpsprefix = preg_match("/^https/", $urlwebsiteinput);
			$ftpprefix = preg_match("/^ftp/", $urlwebsiteinput);
			$telnetprefix = preg_match("/^telnet/", $urlwebsiteinput);
			$gopherprefix = preg_match("/^gopher/", $urlwebsiteinput);
